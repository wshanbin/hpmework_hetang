...
/***/ function(module, exports, __webpack_require__) {
	...
	/*var SingleDatePicker = require('./SingleDatePicker.js');*/
	...
	var MyForm = React.createClass({displayName: "MyForm",
	    ...
	    editHandle: function (event) {
	        ...
	        $.ajax({
	            ...
	            success: function (data) {
	                ...
	                this.setState({flag: flag,id:id,name:name,userType:userType,createTime:createTime,state:state,lastLoginTime:lastLoginTime,remark:remark});
	            }.bind(this)
	        })
	    },
	    preAddHandle: function () {
	        this.setState({flag: "preAdd"});
	    },
	        ...
	        $.ajax({
	            ...
	            success: function (data) {
	                if (data !== null && data !== undefined) {
	                    var list = new Array();
	                    data.array.map(function (index, i) {
	                        list.push(index);
	                    });
	                    var table = new Array();
	                    for (var i = 0; i < list.length; i++) {
	                        ...
	                        arr_td.push(React.createElement("td", {key: "id"}, arr_tr["id"]));
	                        arr_td.push(React.createElement("td", {key: "name"}, arr_tr["name"]));
	                        arr_td.push(React.createElement("td", {key: "lastLoginName"}, arr_tr["lastLoginName"]));
	                        arr_td.push(React.createElement("td", {key: "remark"}, arr_tr["remark"]));
	                        arr_td.push(React.createElement("td", {key: "state"}, arr_tr["state"]));
	                        arr_td.push(React.createElement("td", {key: "userType"}, arr_tr["userType"]));
	                        arr_td.push(React.createElement("td", {key: "createTime"}, arr_tr["createTime"]));
	                        var arr_button = new Array();
	                        arr_button.push(React.createElement("button", {className: "button", value: arr_tr["id"], 
	                                                onClick: this.deleteHandle}, 
	                            "删除"));
	                        arr_button.push(React.createElement("button", {className: "button", value: arr_tr["id"], 
	                                                onClick: this.editHandle}, 
	                            "修改"));
	                        arr_td.push(React.createElement("td", null, arr_button));
	                        table.push(React.createElement("tr", {className: "info"}, arr_td));
	                    }
	                    this.setState({arr: table, flag: "1"})
	                }
	            }.bind(this)
	    ...
	    render: function () {
	        ...
	        if (flag === null || flag === undefined || flag === "2") {
	            ...
	            return (
	                ...
	                React.createElement("table", {className: "table table-bordered"}, 
	                    ...
	                    React.createElement("tr", null, 
	                        React.createElement("td", {id: "idHebing", colSpan: 8}, "用户管理信息表")
	                    ), 
	                    arr, 
	                    React.createElement("tr", null, 
	                        React.createElement("td", {id: "idHebing", colSpan: 8}, 
	                            React.createElement("button", {className: "button", onClick: this.preAddHandle}, "增加")
	                        )
	                    )
	                    )
	                )
	        ...
	        else if (flag !== null && flag !== undefined && flag === "preAdd") {
	            return (
	                React.createElement("div", null, 
	                    React.createElement("table", {className: "table table-bordered"}, 
	                        ...
	                        React.createElement("tr", null, 
	                            ...
	                            React.createElement("td", null, 
	                                React.createElement("select", {className: "select2", onChange: this.handleChange.bind(this,'userType')}, 
	                                    React.createElement("option", {value: "-1"}, "请选择"), 
	                        ...
	                        React.createElement("tr", null, 
	                            ...
	                            React.createElement("td", null, 
	                                React.createElement("input", {type: "text", style: {width:"200px"}, className: "form-control", placeholder: "0000-01-01", 
	                        ...
	                        React.createElement("tr", null, 
	                            ...
	                            React.createElement("td", null, 
	                                React.createElement("input", {type: "text", className: "form-control", placeholder: "state", 
	                        ...
	                        React.createElement("tr", null, 
	                            ...
	                            React.createElement("td", null, 
	                                React.createElement("input", {type: "text", className: "form-control", placeholder: "0000-01-01", 
	                                       onChange: this.handleChange.bind(this,'lastLoginTime')})
	                            )
	                        ...
	                        React.createElement("tr", null, 
	                            ...
	                            React.createElement("td", null, 
	                                React.createElement("input", {type: "text", className: "form-control", placeholder: "remark", 
	                                       onChange: this.handleChange.bind(this,'remark')})
	                            )

	                        ), 
	                        React.createElement("td", {id: "idHebing", colSpan: 2}, 
	                            React.createElement("button", {className: "button", onClick: this.addHandle}, "保存")
	                        )
	                        )
	                    )
	                )
	        ...
	        else if (flag !== null && flag !== undefined && flag === "edit") {
	                ...
	                React.createElement("div", null, 
	                    React.createElement("table", {className: "table table-bordered"}, 
	                        ...
	                        React.createElement("tr", null, 
	                            ...
	                            React.createElement("td", null, 
	                                React.createElement("input", {type: "text", className: "form-control", value: state.name, 
	                                       onChange: this.handleChange.bind(this,'name')})
	                            )
	                        ...
	                        React.createElement("tr", null, 
	                            ...
	                            React.createElement("td", null, 
	                                React.createElement("select", {className: "select2", value: state.userType, checked: state.userType, onChange: this.handleChange.bind(this,'userType')}, 
	                                    React.createElement("option", {value: "-1"}, "请选择"), 
	                                    React.createElement("option", {value: "admin"}, "admin"), 
	                                    React.createElement("option", {value: "student"}, "student"), 
	                                    React.createElement("option", {value: "teacher"}, "teacher")
	                        ...
	                        React.createElement("tr", null, 
	                            ...
	                            React.createElement("td", null, 
	                                React.createElement("input", {type: "text", style: {width:"200px"}, value: state.createTime, className: "form-control", 
	                                       onChange: this.handleChange.bind(this,'createTime')})
	                            )
	                        ...
	                        React.createElement("tr", null, 
	                            ...
	                            React.createElement("td", null, 
	                                React.createElement("input", {type: "text", className: "form-control", value: state.state, 
	                                       onChange: this.handleChange.bind(this,'state')})
	                            )
	                        ...
	                        React.createElement("tr", null, 
	                            ...
	                            React.createElement("td", null, 
	                                React.createElement("input", {type: "text", className: "form-control", value: state.lastLoginTime, 
	                                       onChange: this.handleChange.bind(this,'lastLoginTime')})
	                            )
	                        ...
	                        React.createElement("tr", null, 
	                            ...
	                            React.createElement("td", null, 
	                                React.createElement("input", {type: "text", className: "form-control", value: state.remark, 
	                                       onChange: this.handleChange.bind(this,'remark')})
	                            )

	                        ), 
	                        React.createElement("td", {id: "idHebing", colSpan: 2}, 
	                            React.createElement("button", {className: "button", onClick: this.submitHandle}, "提交")
	                        )
	                        )
	                    )
	                )
	...
	ReactDOM.render(React.createElement(MyForm, null), document.getElementById("info"));
